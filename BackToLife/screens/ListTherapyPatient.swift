...
import SwiftUI
import MapKit
struct list_therapy_Patient: View {
    ...
    @ViewBuilder
    func TherapyCardViewPatient(_ therapy : Therapy) -> some View {
        GeometryReader {
            let size = $0.size
            ...
            HStack(spacing: -25) {
                VStack(alignment: .leading, spacing: 6) {
                    ...
                    HStack(spacing: 4){
                        ...
                        NavigationLink(destination: DetailsScreen(therapy:therapy)) {
            ...
            .rotation3DEffect(.init(degrees: convertOffsetToRotationP(rect)), axis :(x: 1, y:0, z:0), anchor: .center,anchorZ: 1,perspective: 1)
        }
        .frame(height : 220)
    }
    ...
    func convertOffsetToRotationP(_ rect: CGRect) -> CGFloat{
...
var tagsP : [String] = ["History", "Natural","Yoga","happiness","breathing","FANTASIE"]
struct list_therapy_PreviewsP: PreviewProvider {
    static var previews: some View {
        list_therapy()
    }
}

struct URLImageP: View {
